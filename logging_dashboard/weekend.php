<?php
	...
	$weekend_sql = "select count(date_time) from analytics_app_open where date_time between 
	(CURDATE()-INTERVAL DAYOFWEEK(CURDATE()) DAY) and (CURDATE()-INTERVAL DAYOFWEEK(CURDATE()-2) DAY);
	";
	$result = mysqli_query($conn, $weekend_sql);
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="weekdays.php" class=""><i class=""></i> <span>Weekdays data</span></a></li>
						<li><a href="weekend.php" class="active"><i class=""></i> <span>Weekends data</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Weekend Overview</h3>
						</div>
