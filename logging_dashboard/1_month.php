<?php
	...
	$one_month_sql = "select count(date_time) from analytics_app_open where date_time >= (CURDATE()-INTERVAL 1 month);";
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="1_month.php" class="active"><i class=""></i> <span>Last 1 month data</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Last 1 month Overview</h3>
						</div>
