<?php
	...
	$seven_day_sql = "select count(date_time) from analytics_app_open where date_time >= (CURDATE()-INTERVAL 6 DAY);";
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="7_days.php" class="active"><i class=""></i> <span>Last 7 days data</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Last 7 days Overview</h3>
						</div>
