<?php
	...
	$seven_day_sql = "select count(date_time) from analytics_app_open where date_time >= (CURDATE()-INTERVAL 14 DAY);";
	$result = mysqli_query($conn, $seven_day_sql);
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="15_days.php" class="active"><i class=""></i> <span>Last 15 days data</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Last 15 days Overview</h3>
						</div>
