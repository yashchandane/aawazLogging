<?php
	...
	$today_sql = "SELECT count(date_time) from analytics_app_open where date_time >= CURDATE()";
	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="today.php" class="active"><i class=""></i> <span>Today's data</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Todays Overview</h3>
						</div>
