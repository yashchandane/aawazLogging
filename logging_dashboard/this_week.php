<?php
	...
	$this_week_sql = "select count(date_time) from analytics_app_open where date_time >= (CURDATE()-INTERVAL DAYOFWEEK(CURDATE()-1) DAY);";
	$result = mysqli_query($conn, $this_week_sql);
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="this_week.php" class="active"><i class=""></i> <span>This week data</span></a></li>
