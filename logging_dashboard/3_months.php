<?php
	...
	$one_month_sql = "select count(date_time) from analytics_app_open where date_time >= (CURDATE()-INTERVAL 3 MONTH);";
	$result = mysqli_query($conn, $one_month_sql);
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="3_months.php" class="active"><i class=""></i> <span>Last 3 month data</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Last 3 months Overview</h3>
						</div>
